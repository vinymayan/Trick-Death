...
function(copyOutputs TARGET_FOLDER)
    ...
    add_custom_command(
        TARGET "${PROJECT_NAME}" # Use o alvo principal em vez de um custom target problemático
        POST_BUILD
        
        COMMAND "${CMAKE_COMMAND}" -E make_directory "${TARGET_FOLDER}/PrismaUI"
        COMMAND "${CMAKE_COMMAND}" -E copy_directory "${CMAKE_BINARY_DIR}/PrismaUI" "${TARGET_FOLDER}/PrismaUI"
    )
